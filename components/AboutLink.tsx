    ...
    >
      <Link href="/about">
        <motion.button
          ...
          className="group relative bg-artist-brown/90 backdrop-blur-sm text-gallery-50 rounded-full p-4 shadow-gallery hover:shadow-painting transition-all duration-300 hover:bg-artist-sage/80"
